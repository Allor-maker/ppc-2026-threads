...
SmyshlaevAConjGradTaskSEQ::SmyshlaevAConjGradTaskSEQ(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = 0;
}

bool SmyshlaevAConjGradTaskSEQ::ValidationImpl() {
...
bool SmyshlaevAConjGradTaskSEQ::PostProcessingImpl() {
  GetOutput() -= GetInput();
  return GetOutput() > 0;
}
